...
class S2_Admin extends S2_Core {
	...
	public function admin_menu() {
		...
		$s2options = add_submenu_page( 's2_tools', __( 'Options', 'subscribe2' ), __( 'Options', 'subscribe2' ), apply_filters( 's2_capability', 'manage_options', 'options' ), 's2_options', array( $this, 'options_menu' ) );
