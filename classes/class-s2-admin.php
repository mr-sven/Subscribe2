...
class S2_Admin extends S2_Core {
	...
	public function admin_menu() {
		...
		add_submenu_page( 's2_tools', __( 'Options', 'subscribe2' ), __( 'Options', 'subscribe2' ), apply_filters( 's2_capability', 'manage_options', 'options' ), 's2_options', array( $this, 'options_menu' ) );
		add_submenu_page( 's2_tools', __( 'Templates', 'subscribe2' ), __( 'Templates', 'subscribe2' ), apply_filters( 's2_capability', 'manage_options', 'templates' ), 's2_templates', array( $this, 'templates_menu' ) );
	...
	public function options_menu() {
		require_once S2PATH . 'admin/options.php';
	}
